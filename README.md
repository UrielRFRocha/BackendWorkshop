...
Essa separação torna o sistema mais organizado, facilita a manutenção e permite que diferentes frontends (como um site web ou outro aplicativo) consumam a mesma API no futuro.
...
Aprendizado na interpretação de mensagens de erro, warnings do npm e falhas comuns no desenvolvimento
